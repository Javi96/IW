...
<div class = "container">
	<form class = "form-horizontal" name = "teamInfo" method="POST" action = "/changeTeamInfo">
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input id = "trainingSchedule" name = "trainingSchedule" type="text" class = "from-control-text">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input id = "nextMatch" name = "nextMatchSchedule" type="text" class = "from-control">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input id = "nextMatch" name = "nextMatchFacilities" type="text" class = "from-control">
			</div>
		</div>
