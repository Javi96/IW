...
<div class = "container">
	<form class = "form-horizontal" name = "league" method="POST" action = "/addLeague">
		...
		<div class="form-group">
			<label class="col-md-4 col-md-offset-1 control-label" >Deporte:</label>
			<div class="col-md-4">
		...
		<div class="form-group">
			<label class="col-md-4 col-md-offset-1 control-label" >Nombre de la liga:</label>
			<div class="col-md-4">
		...
		<div class="form-group">
			<label class="col-md-4 col-md-offset-1 control-label" >Categoria:</label>
			<div class="col-md-4">
