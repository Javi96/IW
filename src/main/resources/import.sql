...
INSERT INTO team (id,name,school,sport,deputy_id,category,training_schedule,next_match_schedule,next_match_facilities) values (1,'Rugby Fisicas', 'Facultad de Fisicas', 'Rugby', 1,'Masculino','Lunes y Miercoles 14:00h','Viernes 13:30h', 'Paraninfo');
INSERT INTO team (id,name,school,sport,deputy_id,category,training_schedule,next_match_schedule,next_match_facilities) values (2,'Rugby Matematicas', 'Facultad de Matematicas', 'Rugby', 2, 'Masculino','Lunes y Miercoles 14:00h','Viernes 13:30h', 'Cantarranas');
